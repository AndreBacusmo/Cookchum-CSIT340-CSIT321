package appdevproject.cookchum.service;
...
import appdevproject.cookchum.repository.FavRecipeRepository;
...
public class FavRecipeService {
	...
	public FavRecipeEntity putFavRecipeDetails(int id,FavRecipeEntity newFavRecipe) {
		...
		try {
			...
			recipe.setUserId(newFavRecipe.getUserId());
			recipe.setRecipeId(newFavRecipe.getRecipeId());
